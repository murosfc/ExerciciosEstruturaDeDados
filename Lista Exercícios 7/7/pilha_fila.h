...
int removeFila (tipo_fila *); //Remove o primeiro elemento da fila
...
int consultaFilaPorProfundidade (tipo_fila *, int); //retorna o valor do item dada a profundidade informada
